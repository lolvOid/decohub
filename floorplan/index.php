          ...
          <div id="floorTexturesDiv" style="display:none; padding: 0 20px">
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="color: #333333">
                ...
                <div class="col-sm-6" style="padding: 3px">
                  <a href="#" class="thumbnail texture-select-thumbnail" texture-url="rooms/textures/Marble_tiles.jpg" texture-stretch="false" texture-scale="300">
                    <img alt="Thumbnail light fine wood" src="rooms/thumbnails/Marble_tiles.jpg" />
                  </a>
                  
                </div>
                <div class="col-sm-6" style="padding: 3px">
                  <a href="#" class="thumbnail texture-select-thumbnail" texture-url="rooms/textures/Terrazzo_tiles.jpg" texture-stretch="false" texture-scale="300">
          ...
          <div id="wallTextures" style="display:none; padding: 0 20px">
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="color: #333333">
                ...
                <div class="col-sm-6" style="padding: 3px">
                  <a href="#" class="thumbnail texture-select-thumbnail" texture-url="rooms/textures/Wood_planks.jpg" texture-stretch="false" texture-scale="100">
